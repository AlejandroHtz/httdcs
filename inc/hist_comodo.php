...
?>
 <body onload="realizaProcesoComodo();">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-auto">
                            <input type="text" id="inputBuscars" class="form-control" placeholder="Buscar" onkeyup="mayus(this); realizaProcesoComodo();">
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="sube_comodo.php" method="post" enctype="multipart/form-data" id="filesForm">
                    <div>
...
<script>
   ...
   if(inpTodo ==''){
    ...
    $.ajax({
            ...
            url:   'querys/query_hist_comodo.php', //archivo que recibe la peticion
