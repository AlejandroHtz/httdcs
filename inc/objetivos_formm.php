...
w.departamento, w.direccion, w.fechadeingresoorganizacion, sl.id_evaluadordos,
ev.nombre as nombre_evaluador,sl.evaluadodos, pu.id_departamento
from slack sl
...
$id_evaluador = $fila['id_evaluadordos'];
$fechaingreso = $fila['fechadeingresoorganizacion'];
$evaluado = $fila['evaluadodos'];
...
<head>
  ...
  <style type="text/css">
    ...
    td.style998 { vertical-align:middle; text-align:center; border-bottom:1px solid #000000 !important; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; font-weight:bold; color:#FFFFFF; font-family:'Calibri'; font-size:20pt; background-color:#002848 }
    th.style998 { vertical-align:middle; text-align:center; border-bottom:1px solid #000000 !important; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; font-weight:bold; color:#FFFFFF; font-family:'Calibri'; font-size:20pt; background-color:#002848 }
...
<div style="position: relative;"><img  src="../images/netsoft.png" border="0" width="95%" height="95%" /></div></td>
          <td class="column3 style149 s style158" colspan="5" rowspan="5">FORMATO EVALUACIÓN DE OBJETIVOS <br />
</td>
          <td class="column8 style66 s style71" colspan="2" rowspan="5">Ver: 03<br />
<br />
Año: 2023</td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        ...
        <tr class="row9">
          <td class="column0">&nbsp;</td>
          <td class="column1 style55 s style55" colspan="9">Formato Evaluación de Objetivos</td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row10">
        ...
        <tr class="row11">
          <td class="column0">&nbsp;</td>
          <td class="column1 style140 s style148" colspan="9" rowspan="3">Has sido elegido para participar en el proceso de evaluación de objetivos de la organización. Este proceso es de suma importancia para la organización ya que permite tener una visión general de las fortalezas y áreas de oportunidad de cada uno de sus colaboradores, así como las sugerencias que le permitirán a cada uno alcanzar su máximo potencial.</td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row12">
        ...
        <tr class="row25">
          <td class="column0">&nbsp;</td>
          <td class="column1 style3 s">Nombre Lider:</td>
        ...
        <tr class="row27">
          <td class="column0">&nbsp;</td>
          <td class="column1 style3 s" >Período a evaluar:</td>
          <td class="column2 style58 s" colspan="8">Octubre 2022 - Marzo 2023</td> 
        ...
        <tr class="row30">
          <td class="column0">&nbsp;</td>
          <td class="column1 style18 s">Calificación Objetivos</td>
          <td class="column2 style998 f style72" colspan="4"><?php if ($result > 0) { echo $calificacion_objetivos."%"; }?></td>
          <td class="column6 style18 s " colspan="2">Calificación Valores Organizacionales</td>
          <td class="column8 style998 f style72" colspan="2"><?php if ($result > 0) { echo $calific_competencias."%"; }?></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row31">
          <td class="column0">&nbsp;</td>
          <td class="column1 style72 f style72" colspan="5">Calificación Total </td>
          <td class="column6 style72 f style72" colspan="4"><?php if ($result > 0) { echo $calific_total_evaluacion_desempeno."%"; }?></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row32">
        ...
        <tr class="row34">
          <td class="column0">&nbsp;</td> 
          <td class="column1 style59 s style59" colspan="9"><input size="100%" name="InpObjetivoUno" class="auno"  id="InpObjetivoUno" type="text" value="<?php if ($result > 0) { ?><?php echo trim($array[0]["objetivo_dec"]); }else{ if(!isset($array[0]["objetivo_dec"])){  } else { echo trim($array[0]["objetivo_dec"]); } } ?>" readonly placeholder="Escribe tu primer objetivo"  ></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td> 
        </tr>
        <tr class="row35">
          ...
          <input name="InpPesoObjetivoUno" size="19" maxlength="3"  max="100" id="InpPesoObjetivoUno" type="text" readonly  value="<?php if ($result > 0) { ?><?php  if(trim($arr = json_encode($array[0]["peso_objetivo"]),'"') > 0 ){ echo trim($arr = json_encode($array[0]["peso_objetivo"]),'"'); } else{}  }else{ if(!isset($array[0]["peso_objetivo"])){  } else { if(empty(trim($array[0]["peso_objetivo"]))){}else { echo trim($array[0]["peso_objetivo"]); } } } ?>" /> 
           </td>
        ...
        <tr class="row36">
          ...
          <td class="column6 style17 s">Calificación Actual  <button  type="button" style='font-size:15px' data-bs-toggle="modal" data-bs-target="#exampleModal" class='fas fa-exclamation-circle'>  </button></td>
...
<div class="modal-dialog modal-lg">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <h4>Para asignar una calificación a tu colaborador, ten en cuenta la siguiente escala:</h4>
    </div>
    <img src="img/escala.png" class="img-fluid" alt="...">
    <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
        ...
        <tr class="row37"> 
          <td class="column0">&nbsp;</td>                                                                                                        
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjUnoActClaveUnoUno" id="InpObjUnoActClaveUnoUno" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[0]["actividades_clave"]); } else{ if(!isset($array[0]["actividades_clave"])){  } else { echo trim($array[0]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjUnoPesoActUnoUno" readonly id="InpObjUnoPesoActUnoUno" type="text"    value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[0]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[0]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[0]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[0]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjUnoMetaActUnoUno" id="InpObjUnoMetaActUnoUno" type="hidden"  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[0]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[0]["meta_esperada_de_actividad"])){  } else { echo trim($array[0]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjUnoCalifActUnoUno" id="InpObjUnoCalifActUnoUno" <?php if(!empty($array[0]["actividades_clave"])){  } else{ ?> readonly <?php } ?> type="text"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[0]["calificacion_actual"]),'"'); } else{ if(!isset($array[0]["calificacion_actual"])){  } else { echo trim($array[0]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          ...
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[0]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
        ...
        <tr class="row38">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjUnoActClaveDosUno" id="InpObjUnoActClaveDosUno" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[1]["actividades_clave"]); } else{ if(!isset($array[1]["actividades_clave"])){  } else { echo trim($array[1]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjUnoPesoActDosUno" readonly  id="InpObjUnoPesoActDosUno" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[1]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[1]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[1]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[1]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjUnoMetaActDosUno" id="InpObjUnoMetaActDosUno" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[1]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[1]["meta_esperada_de_actividad"])){  } else { echo trim($array[1]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjUnoCalifActDosUno" id="InpObjUnoCalifActDosUno" <?php if(!empty($array[1]["actividades_clave"])){  } else{ ?> readonly <?php } ?> type="text"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[1]["calificacion_actual"]),'"'); } else{ if(!isset($array[1]["calificacion_actual"])){  } else { echo trim($array[1]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          ...
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[1]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
        ...
        <tr class="row39">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjUnoActClaveTresUno" id="InpObjUnoActClaveTresUno" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[2]["actividades_clave"]); } else{ if(!isset($array[2]["actividades_clave"])){  } else { echo trim($array[2]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjUnoPesoActTresUno" readonly  id="InpObjUnoPesoActTresUno" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[2]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[2]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[2]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[2]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjUnoMetaActTresUno" id="InpObjUnoMetaActTresUno" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[2]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[2]["meta_esperada_de_actividad"])){  } else { echo trim($array[2]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjUnoCalifActTresUno" id="InpObjUnoCalifActTresUno" <?php if(!empty($array[2]["actividades_clave"])){  } else{ ?> readonly <?php } ?> type="text"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[2]["calificacion_actual"]),'"'); } else{ if(!isset($array[2]["calificacion_actual"])){  } else { echo trim($array[2]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          ...
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[2]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
        ...
        <tr class="row40">
        <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjUnoActClaveCuatroUno" id="InpObjUnoActClaveCuatroUno" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[3]["actividades_clave"]); } else{ if(!isset($array[3]["actividades_clave"])){  } else { echo trim($array[3]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjUnoPesoActCuatroUno" readonly  id="InpObjUnoPesoActCuatroUno" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[3]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[3]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[3]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[3]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjUnoMetaActCuatroUno" id="InpObjUnoMetaActCuatroUno" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[3]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[3]["meta_esperada_de_actividad"])){  } else { echo trim($array[3]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjUnoCalifActCuatroUno" id="InpObjUnoCalifActCuatroUno" <?php if(!empty($array[3]["actividades_clave"])){  } else{ ?> readonly <?php } ?> type="text"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[3]["calificacion_actual"]),'"'); } else{ if(!isset($array[3]["calificacion_actual"])){  } else { echo trim($array[3]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          ...
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[3]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
        ...
        <tr class="row40">
        <td class="column0">&nbsp;</td>
        <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjUnoActClaveCincoUno" id="InpObjUnoActClaveCincoUno" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[4]["actividades_clave"]); } else{ if(!isset($array[4]["actividades_clave"])){  } else { echo trim($array[4]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjUnoPesoActCincoUno" readonly  id="InpObjUnoPesoActCincoUno" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[4]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[4]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[4]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[4]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjUnoMetaActCincoUno" id="InpObjUnoMetaActCincoUno" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[4]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[4]["meta_esperada_de_actividad"])){  } else { echo trim($array[4]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjUnoCalifActCincoUno" id="InpObjUnoCalifActCincoUno" <?php if(!empty($array[4]["actividades_clave"])){  } else{ ?> readonly <?php } ?> type="text"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[4]["calificacion_actual"]),'"'); } else{ if(!isset($array[4]["calificacion_actual"])){  } else { echo trim($array[4]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          ...
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[4]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea cols="22" rows="1"  name="InpObjUnoComentCincoUno" id="InpObjUnoComentCincoUno" type="text" ><?php if ($result > 0) {  echo trim($array[4]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row41">
          ...
          <td class="column3 style22 f"><?php if ($result > 0) { echo trim(((float)$array[0]["peso_cada_actividad"] + (float)$array[1]["peso_cada_actividad"] + (float)$array[2]["peso_cada_actividad"] + (float)$array[3]["peso_cada_actividad"] + (float)$array[4]["peso_cada_actividad"] ) ) ; } ?></td>
          <td class="column4 style10 f"><?php if ($result > 0) { echo trim(((float)$array[0]["peso_ponderado_actividad"] + (float)$array[1]["peso_ponderado_actividad"] + (float)$array[2]["peso_ponderado_actividad"] + (float)$array[3]["peso_ponderado_actividad"] + (float)$array[4]["peso_ponderado_actividad"] )); } ?></td>
          <td class="column5 style10 null"></td>
          <td class="column6 style10 null"></td>
          <td class="column7 style10 null"></td>
          <td class="column8 style10 f"><?php if ($result > 0) { echo trim(((float)$array[0]["calificacion_ponderada"] + (float)$array[1]["calificacion_ponderada"] + (float)$array[2]["calificacion_ponderada"] + (float)$array[3]["calificacion_ponderada"] + (float)$array[4]["calificacion_ponderada"] ) ); } ?></td>
        ...
        <tr class="row44">
          <td class="column0">&nbsp;</td>
          <td class="column1 style59 s style59" colspan="9"><input size="100%" name="InpObjetivoDos" class="auno"  id="InpObjetivoDos" type="text" value="<?php if ($result > 0) { ?><?php echo trim($array[5]["objetivo_dec"]); }else{ if(!isset($array[5]["objetivo_dec"])){  } else { if(empty(trim($array[5]["objetivo_dec"]))){}else{ echo trim($array[5]["objetivo_dec"]); } } } ?>" readonly placeholder="Escribe tu segundo objetivo"></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row45">
          ...
          <td class="column2 style54 null style54" colspan="2"><input name="InpPesoObjetivoDos" size="19" id="InpPesoObjetivoDos"  type="text" value="<?php if($result > 0) { ?><?php  if(trim($arr = json_encode($array[5]["peso_objetivo"]),'"') > 0 ){ echo trim($arr = json_encode($array[5]["peso_objetivo"]),'"'); } else{ echo "";}  }else{ if(!isset($array[5]["peso_objetivo"])){} else { if(empty(trim($array[5]["peso_objetivo"]))){ echo ""; }else{ echo trim($array[5]["peso_objetivo"]);}}}?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column4 style21 null"></td>
          <td class="column5 style19 null"></td>
          <td class="column6 style19 null"></td>
          <td class="column7 style19 null"></td>
        ...
        <tr class="row47">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveUnoDos" id="InpObjDosActClaveUnoDos" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[5]["actividades_clave"]); } else{ if(!isset($array[5]["actividades_clave"])){  } else { echo trim($array[5]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActUnoDos" readonly  id="InpObjDosPesoActUnoDos" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[5]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[5]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[5]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[5]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActUnoDos" id="InpObjDosMetaActUnoDos" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[5]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[5]["meta_esperada_de_actividad"])){  } else { echo trim($array[5]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjDosCalifActUnoDos" id="InpObjDosCalifActUnoDos" type="text" <?php if(!empty($array[5]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[5]["calificacion_actual"]),'"'); } else{ if(!isset($array[5]["calificacion_actual"])){  } else { echo trim($array[5]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          ...
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[5]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentUnoDos" id="InpObjDosComentUnoDos" type="text" ><?php if ($result > 0) {  echo trim($array[5]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row48">
        <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveDosDos" id="InpObjDosActClaveDosDos" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[6]["actividades_clave"]); } else{ if(!isset($array[6]["actividades_clave"])){  } else { echo trim($array[6]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActDosDos" readonly  id="InpObjDosPesoActDosDos" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[6]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[6]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[6]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[6]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActDosDos" id="InpObjDosMetaActDosDos" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[6]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[6]["meta_esperada_de_actividad"])){  } else { echo trim($array[6]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjDosCalifActDosDos" id="InpObjDosCalifActDosDos" type="text"  <?php if(!empty($array[6]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[6]["calificacion_actual"]),'"'); } else{ if(!isset($array[6]["calificacion_actual"])){  } else { echo trim($array[6]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          ...
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[6]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentDosDos" id="InpObjDosComentDosDos" type="text" ><?php if ($result > 0) {  echo trim($array[6]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row49">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveTresDos" id="InpObjDosActClaveTresDos" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[7]["actividades_clave"]); } else{ if(!isset($array[7]["actividades_clave"])){  } else { echo trim($array[7]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActTresDos" readonly  id="InpObjDosPesoActTresDos"  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[7]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[7]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[7]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[7]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActTresDos" id="InpObjDosMetaActTresDos" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[7]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[7]["meta_esperada_de_actividad"])){  } else { echo trim($array[7]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjDosCalifActTresDos" id="InpObjDosCalifActTresDos" type="text" <?php if(!empty($array[7]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[7]["calificacion_actual"]),'"'); } else{ if(!isset($array[7]["calificacion_actual"])){  } else { echo trim($array[7]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          ...
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[7]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentTresDos" id="InpObjDosComentTresDos" type="text" ><?php if ($result > 0) {  echo trim($array[7]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row50">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveCuatroDos" id="InpObjDosActClaveCuatroDos" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[8]["actividades_clave"]); } else{ if(!isset($array[8]["actividades_clave"])){  } else { echo trim($array[8]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActCuatroDos" readonly  id="InpObjDosPesoActCuatroDos" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[8]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[8]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[8]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[8]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActCuatroDos" id="InpObjDosMetaActCuatroDos" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[8]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[8]["meta_esperada_de_actividad"])){  } else { echo trim($array[8]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjDosCalifActCuatroDos" id="InpObjDosCalifActCuatroDos" type="text" <?php if(!empty($array[8]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[8]["calificacion_actual"]),'"'); } else{ if(!isset($array[8]["calificacion_actual"])){  } else { echo trim($array[8]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          ...
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[8]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentCuatroDos" id="InpObjDosComentCuatroDos" type="text" ><?php if ($result > 0) {  echo trim($array[8]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row50">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveCincoDos" id="InpObjDosActClaveCincoDos" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[9]["actividades_clave"]); } else{ if(!isset($array[9]["actividades_clave"])){  } else { echo trim($array[9]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActCincoDos" readonly  id="InpObjDosPesoActCincoDos" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[9]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[9]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[9]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[9]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActCincoDos" id="InpObjDosMetaActCincoDos" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[9]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[9]["meta_esperada_de_actividad"])){  } else { echo trim($array[9]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjDosCalifActCincoDos" id="InpObjDosCalifActCincoDos" type="text" <?php if(!empty($array[9]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[9]["calificacion_actual"]),'"'); } else{ if(!isset($array[9]["calificacion_actual"])){  } else { echo trim($array[9]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          ...
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[9]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentCincoDos" id="InpObjDosComentCincoDos" type="text" ><?php if ($result > 0) {  echo trim($array[9]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row51">
          <td class="column0">&nbsp;</td>
          <td class="column1 style50 s style51" colspan="2">Total </td>
          <td class="column3 style22 f"><?php if ($result > 0) { echo trim(((int)$array[5]["peso_cada_actividad"] + (int)$array[6]["peso_cada_actividad"] + (int)$array[7]["peso_cada_actividad"] + (int)$array[8]["peso_cada_actividad"] + (int)$array[9]["peso_cada_actividad"] ) ); } ?></td>
          <td class="column4 style10 f"><?php if ($result > 0) { echo trim(((float)$array[5]["peso_ponderado_actividad"] + (float)$array[6]["peso_ponderado_actividad"] + (float)$array[7]["peso_ponderado_actividad"] + (float)$array[8]["peso_ponderado_actividad"] + (float)$array[9]["peso_ponderado_actividad"] )); } ?></td>
          <td class="column5 style10 null"></td>
          <td class="column6 style10 null"></td>
          <td class="column7 style10 null"></td>
          <td class="column8 style10 f"><?php if ($result > 0) { echo trim(((float)$array[5]["calificacion_ponderada"] + (float)$array[6]["calificacion_ponderada"] + (float)$array[7]["calificacion_ponderada"] + (float)$array[8]["calificacion_ponderada"] + (float)$array[9]["calificacion_ponderada"] ) ); } ?></td>
          <td class="column9 style7 null"></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        ...
        <tr class="row55">
          <td class="column0">&nbsp;</td>
          <td class="column1 style59 s style59" colspan="9"><input size="100%" name="InpObjetivoTres" class="auno"  id="InpObjetivoTres" type="text" value="<?php if ($result > 0) { ?><?php echo trim($array[10]["objetivo_dec"]); }else{ if(!isset($array[10]["objetivo_dec"])){  } else { echo trim($array[10]["objetivo_dec"]); } } ?>" readonly placeholder="Escribe tu tercer objetivo"></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row56">
          ...
          <td class="column2 style54 null style54" colspan="2"><input name="InpPesoObjetivoTres" readonly size="19" id="InpPesoObjetivoTres" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?php if ($result > 0) { ?><?php  if(trim($arr = json_encode($array[10]["peso_objetivo"]),'"') > 0 ){ echo trim($arr = json_encode($array[10]["peso_objetivo"]),'"'); } else{}  }else{ if(!isset($array[10]["peso_objetivo"])){  } else {  if (empty(trim($array[10]["peso_objetivo"])) ){} else{ echo trim($array[10]["peso_objetivo"]); } } } ?>"/></td>
          <td class="column4 style21 null"></td>
          <td class="column5 style19 null"></td>
          <td class="column6 style19 null"></td>
          <td class="column7 style19 null"></td>
        ...
        <tr class="row58">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveUnoTres" id="InpObjTresActClaveUnoTres" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[10]["actividades_clave"]); } else{ if(!isset($array[10]["actividades_clave"])){  } else { echo trim($array[10]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActUnoTres" readonly  id="InpObjTresPesoActUnoTres" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[10]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[10]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[10]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[10]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActUnoTres" id="InpObjTresMetaActUnoTres" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[10]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[10]["meta_esperada_de_actividad"])){  } else { echo trim($array[10]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjTresCalifActUnoTres" id="InpObjTresCalifActUnoTres" type="text" <?php if(!empty($array[10]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[10]["calificacion_actual"]),'"'); } else{ if(!isset($array[10]["calificacion_actual"])){  } else { echo trim($array[10]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          ...
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[10]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentUnoTres" id="InpObjTresComentUnoTres" type="text" ><?php if ($result > 0) {  echo trim($array[10]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row59">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveDosTres" id="InpObjTresActClaveDosTres" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[11]["actividades_clave"]); } else{ if(!isset($array[11]["actividades_clave"])){  } else { echo trim($array[11]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActDosTres" readonly  id="InpObjTresPesoActDosTres" type="text"  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[11]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[11]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[11]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[11]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActDosTres" id="InpObjTresMetaActDosTres" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[11]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[11]["meta_esperada_de_actividad"])){  } else { echo trim($array[11]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjTresCalifActDosTres" id="InpObjTresCalifActDosTres" type="text" <?php if(!empty($array[11]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[11]["calificacion_actual"]),'"'); } else{ if(!isset($array[11]["calificacion_actual"])){  } else { echo trim($array[11]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          ...
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[11]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentDosTres" id="InpObjTresComentDosTres" type="text" ><?php if ($result > 0) {  echo trim($array[11]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row60">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveTresTres" id="InpObjTresActClaveTresTres" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[12]["actividades_clave"]); } else{ if(!isset($array[12]["actividades_clave"])){  } else { echo trim($array[12]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActTresTres" readonly  id="InpObjTresPesoActTresTres" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[12]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[12]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[12]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[12]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActTresTres" id="InpObjTresMetaActTresTres" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[12]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[12]["meta_esperada_de_actividad"])){  } else { echo trim($array[12]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjTresCalifActTresTres" id="InpObjTresCalifActTresTres" type="text" <?php if(!empty($array[12]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[12]["calificacion_actual"]),'"'); } else{ if(!isset($array[12]["calificacion_actual"])){  } else { echo trim($array[12]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column7 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode($array[12]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[12]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentTresTres" id="InpObjTresComentTresTres" type="text" ><?php if ($result > 0) {  echo trim($array[12]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row61">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveCuatroTres" id="InpObjTresActClaveCuatroTres" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[13]["actividades_clave"]); } else{ if(!isset($array[13]["actividades_clave"])){  } else { echo trim($array[13]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActCuatroTres" readonly  id="InpObjTresPesoActCuatroTres" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[13]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[13]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[13]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[13]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActCuatroTres" id="InpObjTresMetaActCuatroTres" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[13]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[13]["meta_esperada_de_actividad"])){  } else { echo trim($array[13]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjTresCalifActCuatroTres" id="InpObjTresCalifActCuatroTres" type="text" <?php if(!empty($array[13]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[13]["calificacion_actual"]),'"'); } else{ if(!isset($array[13]["calificacion_actual"])){  } else { echo trim($array[13]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column7 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode($array[13]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[13]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentCuatroTres" id="InpObjTresComentCuatroTres" type="text" ><?php if ($result > 0) {  echo trim($array[13]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row61">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveCincoTres" id="InpObjTresActClaveCincoTres" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[14]["actividades_clave"]); } else{ if(!isset($array[14]["actividades_clave"])){  } else { echo trim($array[14]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActCincoTres" readonly  id="InpObjTresPesoActCincoTres" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[14]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[14]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[14]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[14]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActCincoTres" id="InpObjTresMetaActCincoTres" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[14]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[14]["meta_esperada_de_actividad"])){  } else { echo trim($array[14]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjTresCalifActCincoTres" id="InpObjTresCalifActCincoTres" type="text" <?php if(!empty($array[14]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[14]["calificacion_actual"]),'"'); } else{ if(!isset($array[14]["calificacion_actual"])){  } else { echo trim($array[14]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column7 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode($array[14]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[14]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentCincoTres" id="InpObjTresComentCincoTres" type="text" ><?php if ($result > 0) {  echo trim($array[14]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row62">
          <td class="column0">&nbsp;</td>
          <td class="column1 style50 s style51" colspan="2">Total </td>
          <td class="column3 style22 f"><?php if ($result > 0) { echo trim(((int)$array[10]["peso_cada_actividad"] + (int)$array[11]["peso_cada_actividad"] + (int)$array[12]["peso_cada_actividad"] + (int)$array[13]["peso_cada_actividad"] + (int)$array[14]["peso_cada_actividad"] ) ); } ?></td>
          <td class="column4 style10 f"><?php if ($result > 0) { echo trim(((float)$array[10]["peso_ponderado_actividad"] + (float)$array[11]["peso_ponderado_actividad"] + (float)$array[12]["peso_ponderado_actividad"] + (float)$array[13]["peso_ponderado_actividad"] + (float)$array[14]["peso_ponderado_actividad"] )); } ?></td> 
          <td class="column5 style10 null"></td>
          <td class="column6 style10 null"></td>
          <td class="column7 style10 null"></td>
          <td class="column8 style10 f"><?php if ($result > 0) { echo trim(((float)$array[10]["calificacion_ponderada"] + (float)$array[11]["calificacion_ponderada"] + (float)$array[12]["calificacion_ponderada"] + (float)$array[13]["calificacion_ponderada"] + (float)$array[14]["calificacion_ponderada"] ) ); } ?></td>
        ...
        <tr class="row55">
          <td class="column0">&nbsp;</td>
          <td class="column1 style59 s style59" colspan="9"><input size="100%" name="InpObjetivoCuatro" class="auno"  id="InpObjetivoCuatro" type="text" value="<?php if ($result > 0) { ?><?php echo trim($array[15]["objetivo_dec"]); }else{ if(!isset($array[15]["objetivo_dec"])){  } else { echo trim($array[15]["objetivo_dec"]); } } ?>" readonly placeholder="Escribe tu cuarto objetivo"></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row56">
          <td class="column0">&nbsp;</td>
          <td class="column1 style18 s">Peso Objetivo 4: </td>                                               
          <td class="column2 style54 null style54" colspan="2"><input name="InpPesoObjetivoCuatro" readonly size="19" id="InpPesoObjetivoCuatro" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?php if ($result > 0) { ?><?php  if(trim($arr = json_encode($array[15]["peso_objetivo"]),'"') > 0 ){ echo trim($arr = json_encode($array[15]["peso_objetivo"]),'"'); } else{}  }else{ if(!isset($array[15]["peso_objetivo"])){  } else {  if (empty(trim($array[15]["peso_objetivo"])) ){} else{ echo trim($array[15]["peso_objetivo"]); } } } ?>"/></td>
          <td class="column4 style21 null"></td>
          <td class="column5 style19 null"></td>
          <td class="column6 style19 null"></td>
          <td class="column7 style19 null"></td>
        ...
        <tr class="row58">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjCuatroActClaveUnoCuatro" id="InpObjCuatroActClaveUnoCuatro" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[15]["actividades_clave"]); } else{ if(!isset($array[15]["actividades_clave"])){  } else { echo trim($array[15]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjCuatroPesoActUnoCuatro" readonly  id="InpObjCuatroPesoActUnoCuatro" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[15]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[15]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[15]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[15]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjCuatroMetaActUnoCuatro" id="InpObjCuatroMetaActUnoCuatro" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[15]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[15]["meta_esperada_de_actividad"])){  } else { echo trim($array[15]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjCuatroCalifActUnoCuatro" id="InpObjCuatroCalifActUnoCuatro" type="text" <?php if(!empty($array[15]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[15]["calificacion_actual"]),'"'); } else{ if(!isset($array[15]["calificacion_actual"])){  } else { echo trim($array[15]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column7 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode($array[15]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[15]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjCuatroComentUnoCuatro" id="InpObjCuatroComentUnoCuatro" type="text" ><?php if ($result > 0) {  echo trim($array[15]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row59">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjCuatroActClaveDosCuatro" id="InpObjCuatroActClaveDosCuatro" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[16]["actividades_clave"]); } else{ if(!isset($array[16]["actividades_clave"])){  } else { echo trim($array[16]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjCuatroPesoActDosCuatro" readonly  id="InpObjCuatroPesoActDosCuatro" type="text"  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[16]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[16]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[16]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[16]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjCuatroMetaActDosCuatro" id="InpObjCuatroMetaActDosCuatro" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[16]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[16]["meta_esperada_de_actividad"])){  } else { echo trim($array[16]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjCuatroCalifActDosCuatro" id="InpObjCuatroCalifActDosCuatro" type="text" <?php if(!empty($array[16]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[16]["calificacion_actual"]),'"'); } else{ if(!isset($array[16]["calificacion_actual"])){  } else { echo trim($array[16]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column7 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode($array[16]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[16]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjCuatroComentDosCuatro" id="InpObjCuatroComentDosCuatro" type="text" ><?php if ($result > 0) {  echo trim($array[16]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row60">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjCuatroActClaveTresCuatro" id="InpObjCuatroActClaveTresCuatro" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[17]["actividades_clave"]); } else{ if(!isset($array[17]["actividades_clave"])){  } else { echo trim($array[17]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjCuatroPesoActTresCuatro" readonly  id="InpObjCuatroPesoActTresCuatro" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[17]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[17]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[17]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[17]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjCuatroMetaActTresCuatro" id="InpObjCuatroMetaActTresCuatro" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[17]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[17]["meta_esperada_de_actividad"])){  } else { echo trim($array[17]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjCuatroCalifActTresCuatro" id="InpObjCuatroCalifActTresCuatro" type="text" <?php if(!empty($array[17]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[17]["calificacion_actual"]),'"'); } else{ if(!isset($array[17]["calificacion_actual"])){  } else { echo trim($array[17]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column7 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode($array[17]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[17]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjCuatroComentTresCuatro" id="InpObjCuatroComentTresCuatro" type="text" ><?php if ($result > 0) {  echo trim($array[17]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row61">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjCuatroActClaveCuatroCuatro" id="InpObjCuatroActClaveCuatroCuatro" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[18]["actividades_clave"]); } else{ if(!isset($array[18]["actividades_clave"])){  } else { echo trim($array[18]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjCuatroPesoActCuatroCuatro" readonly  id="InpObjCuatroPesoActCuatroCuatro" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[18]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[18]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[18]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[18]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjCuatroMetaActCuatroCuatro" id="InpObjCuatroMetaActCuatroCuatro" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[18]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[18]["meta_esperada_de_actividad"])){  } else { echo trim($array[18]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjCuatroCalifActCuatroCuatro" id="InpObjCuatroCalifActCuatroCuatro" type="text" <?php if(!empty($array[18]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[18]["calificacion_actual"]),'"'); } else{ if(!isset($array[18]["calificacion_actual"])){  } else { echo trim($array[18]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column7 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode($array[18]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[18]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjCuatroComentCuatroCuatro" id="InpObjCuatroComentCuatroCuatro" type="text" ><?php if ($result > 0) {  echo trim($array[18]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row61">
          <td class="column0">&nbsp;</td>
          <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjCuatroActClaveCincoCuatro" id="InpObjCuatroActClaveCincoCuatro" type="text" readonly placeholder="Actividades Clave" readonly ><?php if ($result > 0) {  echo trim($array[19]["actividades_clave"]); } else{ if(!isset($array[19]["actividades_clave"])){  } else { echo trim($array[19]["actividades_clave"]); } } ?></textarea></td>
          <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjCuatroPesoActCincoCuatro" readonly  id="InpObjCuatroPesoActCincoCuatro" type="text" value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[19]["peso_cada_actividad"]),'"'); } else{ if(!isset($array[19]["peso_cada_actividad"])){  } else { echo trim($arr = json_encode($array[19]["peso_cada_actividad"]),'"'); } } ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
          <td class="column4 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[19]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjCuatroMetaActCincoCuatro" id="InpObjCuatroMetaActCincoCuatro" type="hidden"   value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[19]["meta_esperada_de_actividad"]),'"'); } else{ if(!isset($array[19]["meta_esperada_de_actividad"])){  } else { echo trim($array[19]["meta_esperada_de_actividad"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjCuatroCalifActCincoCuatro" id="InpObjCuatroCalifActCincoCuatro" type="text" <?php if(!empty($array[19]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[19]["calificacion_actual"]),'"'); } else{ if(!isset($array[19]["calificacion_actual"])){  } else { echo trim($array[19]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column7 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode($array[19]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column8 style9 f"><?php if ($result > 0) {  echo trim($arr = json_encode(round($array[19]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
          <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjCuatroComentCincoCuatro" id="InpObjCuatroComentCincoCuatro" type="text" ><?php if ($result > 0) {  echo trim($array[19]["comentarios"]); }?></textarea></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row62">
          <td class="column0">&nbsp;</td>
          <td class="column1 style50 s style51" colspan="2">Total </td>
          <td class="column3 style22 f"><?php if ($result > 0) { echo trim(((int)$array[15]["peso_cada_actividad"] + (int)$array[16]["peso_cada_actividad"] + (int)$array[17]["peso_cada_actividad"] + (int)$array[18]["peso_cada_actividad"] + (int)$array[19]["peso_cada_actividad"] ) ); } ?></td>
          <td class="column4 style10 f"><?php if ($result > 0) { echo trim(((float)$array[15]["peso_ponderado_actividad"] + (float)$array[16]["peso_ponderado_actividad"] + (float)$array[17]["peso_ponderado_actividad"] + (float)$array[18]["peso_ponderado_actividad"] + (float)$array[19]["peso_ponderado_actividad"] )); } ?></td> 
          <td class="column5 style10 null"></td>
          <td class="column6 style10 null"></td>
          <td class="column7 style10 null"></td>
          <td class="column8 style10 f"><?php if ($result > 0) { echo trim(((float)$array[15]["calificacion_ponderada"] + (float)$array[16]["calificacion_ponderada"] + (float)$array[17]["calificacion_ponderada"] + (float)$array[18]["calificacion_ponderada"] + (float)$array[19]["calificacion_ponderada"] ) ); } ?></td>
          <td class="column9 style7 null"></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        ...
        <tr class="row66">
          ...
          <td class="column1 style43 null style43" colspan="4" rowspan="5"><textarea cols="86" rows="6"  name="InpFortalezas" id="InpFortalezas" type="text" ><?php if ($result > 0) { echo $fortalezas; }?></textarea></td> 
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row67">
        ...
        <?php 
  if ($result > 0 && $comentarioevaluado !='' ){ ?> 
  <tr class="row72">
          <td class="column0">&nbsp;</td>
          <td class="column1">&nbsp;</td>
          <td class="column2">&nbsp;</td>
        ...
        <tr class="row71">
          <td class="column0">&nbsp;</td>
          <td class="column1 style40 s style42" colspan="9">Comentario del evaluado</td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row74">
          <td class="column0">&nbsp;</td>
          <td class="column1 style43 null style43" colspan="9" rowspan="5"><textarea cols="175" rows="6" readonly name="InpComEvalu" id="InpComEvalu" type="text" ><?php echo $comentarioevaluado; ?></textarea> </td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
          </tr>
  ...
  if($evaluado == 0){
  if ($result > 0) { ?>
    <center><button id="btnactualizar" name="btnactualizar" class="btn btn-primary" onclick="realizaProcesoActu();">Actualizar</button></center> <br>
    <center> 
  <?php    if($result > 0 && $resultss > 0){ ?>
    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#enviar">

  Enviar
</button>   

<a type="button" class="btn btn-primary" href="https://calendar.google.com/calendar/u/0/r/eventedit?vcon=meet&dates=now&hl=es-419"  target="_blank" >Generar retro</a>

<?php } ?> 
  </center>
    <?php }else{ ?>
  <center><button id="btnguardarfor" name="btnguardarfor" class="btn btn-primary" onclick="realizaProceso();">Registrar</button></center>
  <?php  } }?> 
  <br>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body">
    <center> <h3>Asegúrate de haber dado retroalimentación a tu colaborador y solicita los 11 dígitos del número de seguro social</h3></center>
    </div>
      <form id="formenv">
        <center> 
          <input type="hidden" name="id_slack" value="<?php echo $id_slack; ?>">
          <input type="text" name="n_sss" id="n_sss" class="form-control"  placeholder="Escriba el NSS del evaluado" >
      <button  data-bs-dismiss="modal"  >Cancelar</button>
      <button type="button" onclick="realizaProcesoActuEnviar();" class="btn btn-danger">Aceptar</button>
      </center>
      <br>
      </form>
...
function realizaProceso(){
    ...
    var datos = $('#insform').serialize();
    $.ajax({
      type: "POST", 
      url: "ins_objet_new.php", 
      data: datos, 
      beforeSend: function () {
...
function realizaProcesoActu(){

    var datos = $('#insform').serialize();

    $.ajax({
      type: "POST",  
      url: "ins_objet_act_new.php",
      data: datos, 
      beforeSend: function () {
                  $("#resultado").html("Procesando, espere por favor...");
          }, 
...
function realizaProcesoActuEnviar(){
  nss = document.getElementById('n_sss').value;
if(nss !=''){ 
var datose = $('#formenv').serialize();
$.ajax({
type: "POST", 
url: "enviar_new.php", 
data: datose, 
beforeSend: function () {
    ...
    success:  function (responsee) { //una vez que el archivo recibe el request lo procesa y lo devuelve
            $("#resultado").html(responsee);
            alert(responsee);
            if(responsee ==="Enviado"){
              location.reload();
            }
    }
});
} else { alert("Ingresa los 11 dígitos del número de seguro social" ); }
};
