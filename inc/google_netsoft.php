    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Importar (google_netsoft.xlsx)</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="sube_netsoft.php" method="post" enctype="multipart/form-data" id="filesForm">
                    <div>
...
<script>
   ...
   if(inpTodo ==''){
    ...
    $.ajax({
            ...
            url:   'query_gnetsof.php', //archivo que recibe la peticion
