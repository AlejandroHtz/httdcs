    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Importar (lista.xlsx)</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="sube.php" method="post" enctype="multipart/form-data" id="filesForm">
                    <div>
...
<script>
   ...
   if(inpTodo ==''){
    ...
    $.ajax({
            ...
            url:   'query_slack.php', //archivo que recibe la peticion
