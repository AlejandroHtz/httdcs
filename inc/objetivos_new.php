...
ev.nombre as nombre_evaluador,sl.evaluadodos
from slack sl
...
<div class="modal-dialog modal-lg">
  ...
  <tr class="row72">
    ...
    <?php if ($result > 0) { ?>
      ...
      <textarea cols="175" rows="6"  name="InpComEvalunew" id="InpComEvalunew" type="text" ><?php echo $comentarioevaluado; ?></textarea> 
