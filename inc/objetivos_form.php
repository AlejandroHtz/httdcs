...
ev.nombre as nombre_evaluador,sl.evaluado, pu.id_puesto
from slack sl
...
Año: 2022</td>
        ...
        <tr class="row27">
          ...
          <td class="column2 style58 s" colspan="8">2023</td> 
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <h4>Recuerda que la calificación va desde 0 a 100, donde 0 es la calificación más baja y 100 es la más alta.</h4>
    </div>
    <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
        ...
        <tr class="row44">
          <td class="column0">&nbsp;</td>
          <td class="column1 style59 s style59" colspan="9"><input size="100%" name="InpObjetivoDos" class="auno"  id="InpObjetivoDos" type="text" value="<?php if ($result > 0) { ?><?php echo trim($array[4]["objetivo_dec"]); }else{ if(!isset($array[4]["objetivo_dec"])){  } else { if(empty(trim($array[4]["objetivo_dec"]))){}else{ echo trim($array[4]["objetivo_dec"]); } } } ?>" readonly placeholder="Escribe tu segundo objetivo"></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row45">
          ...
          <td class="column2 style54 null style54" colspan="2"><input name="InpPesoObjetivoDos" size="19" id="InpPesoObjetivoDos"  type="text" value="<?php if($result > 0) { ?><?php  if(trim($arr = json_encode($array[4]["peso_objetivo"]),'"') > 0 ){ echo trim($arr = json_encode($array[4]["peso_objetivo"]),'"'); } else{ echo "";}  }else{ if(!isset($array[4]["peso_objetivo"])){} else { if(empty(trim($array[4]["peso_objetivo"]))){ echo ""; }else{ echo trim($array[4]["peso_objetivo"]);}}}?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
          <td class="column4 style21 null"></td>
          <td class="column5 style19 null"></td>
          <td class="column6 style19 null"></td>
          <td class="column7 style19 null"></td>
        ...
        <td class="column0">&nbsp;</td>
          ...
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjDosCalifActDosDos" id="InpObjDosCalifActDosDos" type="text"  <?php if(!empty($array[5]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[5]["calificacion_actual"]),'"'); } else{ if(!isset($array[5]["calificacion_actual"])){  } else { echo trim($array[5]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
        ...
        <tr class="row50">
          ...
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjDosCalifActCuatroDos" id="InpObjDosCalifActCuatroDos" type="text" <?php if(!empty($array[7]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[7]["calificacion_actual"]),'"'); } else{ if(!isset($array[7]["calificacion_actual"])){  } else { echo trim($array[7]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
        ...
        <tr class="row55">
          <td class="column0">&nbsp;</td>
          <td class="column1 style59 s style59" colspan="9"><input size="100%" name="InpObjetivoTres" class="auno"  id="InpObjetivoTres" type="text" value="<?php if ($result > 0) { ?><?php echo trim($array[8]["objetivo_dec"]); }else{ if(!isset($array[8]["objetivo_dec"])){  } else { echo trim($array[8]["objetivo_dec"]); } } ?>" readonly placeholder="Escribe tu tercer objetivo"></td>
          <td class="column10">&nbsp;</td>
          <td class="column11">&nbsp;</td>
        </tr>
        <tr class="row56">
          ...
          <td class="column2 style54 null style54" colspan="2"><input name="InpPesoObjetivoTres" readonly size="19" id="InpPesoObjetivoTres" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?php if ($result > 0) { ?><?php  if(trim($arr = json_encode($array[8]["peso_objetivo"]),'"') > 0 ){ echo trim($arr = json_encode($array[8]["peso_objetivo"]),'"'); } else{}  }else{ if(!isset($array[8]["peso_objetivo"])){  } else {  if (empty(trim($array[8]["peso_objetivo"])) ){} else{ echo trim($array[8]["peso_objetivo"]); } } } ?>"/></td>
          <td class="column4 style21 null"></td>
          <td class="column5 style19 null"></td>
          <td class="column6 style19 null"></td>
          <td class="column7 style19 null"></td>
        ...
        <tr class="row61">
          ...
          <td class="column6 style17 null"><input size="13" maxlength="3" name="InpObjTresCalifActCuatroTres" id="InpObjTresCalifActCuatroTres" type="text" <?php if(!empty($array[11]["actividades_clave"])){  } else{ ?> readonly <?php } ?>  value="<?php if ($result > 0) { ?><?php echo trim($arr = json_encode($array[11]["calificacion_actual"]),'"'); } else{ if(!isset($array[11]["calificacion_actual"])){  } else { echo trim($array[11]["calificacion_actual"]); } }  ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
