...
require 'header.php';
 ...
 $an = $_GET['a'];
 $pr = $_GET['p'];
$sqlselecu = "SELECT * from departamentos
      where id_departamento = $id_posicion";
      $registrcu = mysqli_query($conexion, $sqlselecu);
      $regonecontcu = mysqli_fetch_array($registrcu);
      $puestoo = $regonecontcu["puesto"];


$sqlselecObj = "SELECT * from obg_puestos_new 
...
$registrcObj = mysqli_query($conexion, $sqlselecObj);
 ...
 $resultjj= mysqli_num_rows($registrcObj);
 if ($resultjj > 0) { 
  ...
  <form id="insform">
    ...
    <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0">
        ...
        <tbody>
          ...
          <tr class="row34">
            <td class="column0">&nbsp;</td>
            <td class="column1 style59 s style59" colspan="9"><input size="100%" name="InpObjetivoUno" class="auno"  id="InpObjetivoUno" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($array[0]["objetivo_dec"]); }?>" placeholder="Escribe tu primer objetivo"  ></td>
          ...
          <tr class="row35">
            ...
            <input name="InpPesoObjetivoUno" size="19" maxlength="3"  max="100" id="InpPesoObjetivoUno" type="text"  <?php if ($resultjj > 0) { ?> value="<?php  if(trim($arr = json_encode($array[0]["peso_objetivo"]),'"') > 0 ){ echo trim($arr = json_encode($array[0]["peso_objetivo"]),'"'); } else{}  }?>" /> 
             </td>
            ...
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
            <input type="hidden" name="id_posicion" value="<?php echo $id_posicion ?>">
            <input type="hidden" name="id_user" value="<?php echo $id_user ?>">
            <input type="hidden" name="anio" value="<?php echo $an ?>">
            <input type="hidden" name="periodo" value="<?php echo $pr ?>">
          ...
          <tr class="row37">
            <td class="column0">&nbsp;</td>                                                                                                                                                       
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjUnoActClaveUnoUno" id="InpObjUnoActClaveUnoUno" type="text" placeholder="Actividades Clave"><?php if ($resultjj > 0) {  echo trim($array[0]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjUnoPesoActUnoUno" id="InpObjUnoPesoActUnoUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[0]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[0]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjUnoMetaActUnoUno" id="InpObjUnoMetaActUnoUno" type="text"  <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[0]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjUnoCalifActUnoUno" id="InpObjUnoCalifActUnoUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[0]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[0]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[0]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjUnoComentUnoUno" id="InpObjUnoComentUnoUno" type="text" ><?php if ($resultjj> 0) {  echo trim($array[0]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row38">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjUnoActClaveDosUno" id="InpObjUnoActClaveDosUno" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[1]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjUnoPesoActDosUno" id="InpObjUnoPesoActDosUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[1]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[1]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjUnoMetaActDosUno" id="InpObjUnoMetaActDosUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[1]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjUnoCalifActDosUno" id="InpObjUnoCalifActDosUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[1]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td> 
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[1]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[1]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea cols="22" rows="1"  name="InpObjUnoComentDosUno" id="InpObjUnoComentDosUno" type="text" ><?php if ($resultjj> 0) {  echo trim($array[1]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row39">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjUnoActClaveTresUno" id="InpObjUnoActClaveTresUno" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[2]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjUnoPesoActTresUno" id="InpObjUnoPesoActTresUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[2]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[2]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjUnoMetaActTresUno" id="InpObjUnoMetaActTresUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[2]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjUnoCalifActTresUno" id="InpObjUnoCalifActTresUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[2]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td> 
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[2]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[2]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea cols="22" rows="1"  name="InpObjUnoComentTresUno" id="InpObjUnoComentTresUno" type="text" ><?php if ($resultjj> 0) {  echo trim($array[2]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row40">
          <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjUnoActClaveCuatroUno" id="InpObjUnoActClaveCuatroUno" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[3]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjUnoPesoActCuatroUno" id="InpObjUnoPesoActCuatroUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[3]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[3]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjUnoMetaActCuatroUno" id="InpObjUnoMetaActCuatroUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[3]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjUnoCalifActCuatroUno" id="InpObjUnoCalifActCuatroUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[3]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td> 
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[3]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[3]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea cols="22" rows="1"  name="InpObjUnoComentCuatroUno" id="InpObjUnoComentCuatroUno" type="text" ><?php if ($resultjj> 0) {  echo trim($array[3]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjUnoActClaveCincoUno" id="InpObjUnoActClaveCincoUno" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[4]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjUnoPesoActCincoUno" id="InpObjUnoPesoActCincoUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[4]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[4]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjUnoMetaActCincoUno" id="InpObjUnoMetaActCincoUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[4]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjUnoCalifActCincoUno" id="InpObjUnoCalifActCincoUno" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[4]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td> 
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[4]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[4]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea cols="22" rows="1"  name="InpObjUnoComentCincoUno" id="InpObjUnoComentCincoUno" type="text" ><?php if ($resultjj> 0) {  echo trim($array[4]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row41">
            ...
            <td class="column3 style22 f"><?php if ($resultjj> 0) { echo trim(((int)$array[0]["peso_cada_actividad"] + (int)$array[1]["peso_cada_actividad"] + (int)$array[2]["peso_cada_actividad"] + (int)$array[3]["peso_cada_actividad"] + (int)$array[4]["peso_cada_actividad"] ) ); } ?></td>
            <td class="column4 style10 f"><?php if ($resultjj> 0) { echo trim(((float)$array[0]["peso_ponderado_actividad"] + (float)$array[1]["peso_ponderado_actividad"] + (float)$array[2]["peso_ponderado_actividad"] + (float)$array[3]["peso_ponderado_actividad"] + (float)$array[4]["peso_ponderado_actividad"] )) ; } ?></td>
            <td class="column5 style10 null"></td>
            <td class="column6 style10 null"></td>
            <td class="column7 style10 null"></td>
            <td class="column8 style10 f"><?php if ($resultjj> 0) {echo trim(((float)$array[0]["calificacion_ponderada"] + (float)$array[1]["calificacion_ponderada"] + (float)$array[2]["calificacion_ponderada"] + (float)$array[3]["calificacion_ponderada"] + (float)$array[4]["calificacion_ponderada"] ) ); } ?></td>
          ...
          <tr class="row44">
            <td class="column0">&nbsp;</td>
            <td class="column1 style59 s style59" colspan="9"><input size="100%" name="InpObjetivoDos" class="auno"  id="InpObjetivoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($array[5]["objetivo_dec"]); }?>" placeholder="Escribe tu segundo objetivo"></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row45">
            ...
            <td class="column2 style54 null style54" colspan="2"><input name="InpPesoObjetivoDos" size="19" id="InpPesoObjetivoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php  if(trim($arr = json_encode($array[5]["peso_objetivo"]),'"') > 0 ){ echo trim($arr = json_encode($array[5]["peso_objetivo"]),'"'); } else{}  }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style21 null"></td>
            <td class="column5 style19 null"></td>
            <td class="column6 style19 null"></td>
            <td class="column7 style19 null"></td>
          ...
          <tr class="row47">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveUnoDos" id="InpObjDosActClaveUnoDos" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[5]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActUnoDos" id="InpObjDosPesoActUnoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[5]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[5]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActUnoDos" id="InpObjDosMetaActUnoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[5]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjDosCalifActUnoDos" id="InpObjDosCalifActUnoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[5]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[5]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[5]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentUnoDos" id="InpObjDosComentUnoDos" type="text" ><?php if ($resultjj> 0) {  echo trim($array[5]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row48">
          <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveDosDos" id="InpObjDosActClaveDosDos" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[6]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActDosDos" id="InpObjDosPesoActDosDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[6]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[6]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActDosDos" id="InpObjDosMetaActDosDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[6]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjDosCalifActDosDos" id="InpObjDosCalifActDosDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[6]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[6]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[6]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentDosDos" id="InpObjDosComentDosDos" type="text" ><?php if ($resultjj> 0) {  echo trim($array[6]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row49">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveTresDos" id="InpObjDosActClaveTresDos" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[7]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActTresDos" id="InpObjDosPesoActTresDos" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[7]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[7]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActTresDos" id="InpObjDosMetaActTresDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[7]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjDosCalifActTresDos" id="InpObjDosCalifActTresDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[7]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[7]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[7]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentTresDos" id="InpObjDosComentTresDos" type="text" ><?php if ($resultjj> 0) {  echo trim($array[7]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row50">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveCuatroDos" id="InpObjDosActClaveCuatroDos" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[8]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActCuatroDos" id="InpObjDosPesoActCuatroDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[8]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[8]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActCuatroDos" id="InpObjDosMetaActCuatroDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[8]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjDosCalifActCuatroDos" id="InpObjDosCalifActCuatroDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[8]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[8]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[8]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentCuatroDos" id="InpObjDosComentCuatroDos" type="text" ><?php if ($resultjj> 0) {  echo trim($array[8]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row50">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveCincoDos" id="InpObjDosActClaveCincoDos" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[9]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActCincoDos" id="InpObjDosPesoActCincoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[9]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[9]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActCincoDos" id="InpObjDosMetaActCincoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[9]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjDosCalifActCincoDos" id="InpObjDosCalifActCincoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[9]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[9]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[9]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentCincoDos" id="InpObjDosComentCincoDos" type="text" ><?php if ($resultjj> 0) {  echo trim($array[9]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row51">
            <td class="column0">&nbsp;</td>
            <td class="column1 style50 s style51" colspan="2">Total </td>
            <td class="column3 style22 f"><?php if ($resultjj> 0) { echo trim(((int)$array[5]["peso_cada_actividad"] + (int)$array[6]["peso_cada_actividad"] + (int)$array[7]["peso_cada_actividad"] + (int)$array[8]["peso_cada_actividad"] + (int)$array[9]["peso_cada_actividad"] ) ); } ?></td>
            <td class="column4 style10 f"><?php if ($resultjj> 0) { echo trim(((float)$array[5]["peso_ponderado_actividad"] + (float)$array[6]["peso_ponderado_actividad"] + (float)$array[7]["peso_ponderado_actividad"] + (float)$array[8]["peso_ponderado_actividad"] + (float)$array[9]["peso_ponderado_actividad"] )); } ?></td>
            <td class="column5 style10 null"></td>
            <td class="column6 style10 null"></td>
            <td class="column7 style10 null"></td>
            <td class="column8 style10 f"><?php if ($resultjj> 0) { echo trim(((float)$array[5]["calificacion_ponderada"] + (float)$array[6]["calificacion_ponderada"] + (float)$array[7]["calificacion_ponderada"] + (float)$array[8]["calificacion_ponderada"] + (float)$array[9]["calificacion_ponderada"] ) ); } ?></td>
            <td class="column9 style7 null"></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          ...
          <tr class="row55">
            <td class="column0">&nbsp;</td>
            <td class="column1 style59 s style59" colspan="9"><input size="100%" name="InpObjetivoTres" class="auno"  id="InpObjetivoTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($array[10]["objetivo_dec"]); }?>" placeholder="Escribe tu tercer objetivo"></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row56">
            ...
            <td class="column2 style54 null style54" colspan="2"><input name="InpPesoObjetivoTres" size="19" id="InpPesoObjetivoTres" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' <?php if ($resultjj> 0) { ?> value="<?php  if(trim($arr = json_encode($array[10]["peso_objetivo"]),'"') > 0 ){ echo trim($arr = json_encode($array[10]["peso_objetivo"]),'"'); } else{}  }?>"/></td>
            <td class="column4 style21 null"></td>
            <td class="column5 style19 null"></td>
            <td class="column6 style19 null"></td>
            <td class="column7 style19 null"></td>
          ...
          <tr class="row58">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveUnoTres" id="InpObjTresActClaveUnoTres" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[10]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActUnoTres" id="InpObjTresPesoActUnoTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[10]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[10]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActUnoTres" id="InpObjTresMetaActUnoTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[10]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjTresCalifActUnoTres" id="InpObjTresCalifActUnoTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[10]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[10]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[10]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentUnoTres" id="InpObjTresComentUnoTres" type="text" ><?php if ($resultjj> 0) {  echo trim($array[10]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row59">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveDosTres" id="InpObjTresActClaveDosTres" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[11]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActDosTres" id="InpObjTresPesoActDosTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[11]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[11]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActDosTres" id="InpObjTresMetaActDosTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[11]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjTresCalifActDosTres" id="InpObjTresCalifActDosTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[11]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[11]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[11]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentDosTres" id="InpObjTresComentDosTres" type="text" ><?php if ($resultjj> 0) {  echo trim($array[11]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row60">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveTresTres" id="InpObjTresActClaveTresTres" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[12]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActTresTres" id="InpObjTresPesoActTresTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[12]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode(round($array[12]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActTresTres" id="InpObjTresMetaActTresTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[12]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjTresCalifActTresTres" id="InpObjTresCalifActTresTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[12]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode($array[12]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode(round($array[12]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentTresTres" id="InpObjTresComentTresTres" type="text" ><?php if ($resultjj > 0) {  echo trim($array[12]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row61">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveCuatroTres" id="InpObjTresActClaveCuatroTres" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[13]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActCuatroTres" id="InpObjTresPesoActCuatroTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[13]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode(round($array[13]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActCuatroTres" id="InpObjTresMetaActCuatroTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[13]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjTresCalifActCuatroTres" id="InpObjTresCalifActCuatroTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[13]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode($array[13]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode(round($array[13]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentCuatroTres" id="InpObjTresComentCuatroTres" type="text" ><?php if ($resultjj > 0) {  echo trim($array[13]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row61">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveCincoTres" id="InpObjTresActClaveCincoTres" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[14]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActCincoTres" id="InpObjTresPesoActCincoTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[14]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode(round($array[14]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActCincoTres" id="InpObjTresMetaActCincoTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[14]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjTresCalifActCincoTres" id="InpObjTresCalifActCincoTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[14]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode($array[14]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode(round($array[14]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentCincoTres" id="InpObjTresComentCincoTres" type="text" ><?php if ($resultjj > 0) {  echo trim($array[14]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row62">
            <td class="column0">&nbsp;</td>
            <td class="column1 style50 s style51" colspan="2">Total </td>
            <td class="column3 style22 f"><?php if ($resultjj> 0) { echo trim(((int)$array[10]["peso_cada_actividad"] + (int)$array[11]["peso_cada_actividad"] + (int)$array[12]["peso_cada_actividad"] + (int)$array[13]["peso_cada_actividad"] + (int)$array[14]["peso_cada_actividad"] ) ); } ?></td>
            <td class="column4 style10 f"><?php if ($resultjj> 0) { echo trim(((float)$array[10]["peso_ponderado_actividad"] + (float)$array[11]["peso_ponderado_actividad"] + (float)$array[12]["peso_ponderado_actividad"] + (float)$array[13]["peso_ponderado_actividad"] + (float)$array[14]["peso_ponderado_actividad"] )) ; } ?></td> 
            <td class="column5 style10 null"></td>
            <td class="column6 style10 null"></td>
            <td class="column7 style10 null"></td>
            <td class="column8 style10 f"><?php if ($resultjj> 0) { echo trim(((float)$array[10]["calificacion_ponderada"] + (float)$array[11]["calificacion_ponderada"] + (float)$array[12]["calificacion_ponderada"] + (float)$array[13]["calificacion_ponderada"] + (float)$array[14]["calificacion_ponderada"] ) ); } ?></td>
          ...
          <tr class="row55">
            <td class="column0">&nbsp;</td>
            <td class="column1 style59 s style59" colspan="9"><input size="100%" name="InpObjetivoCuatro" class="auno"  id="InpObjetivoCuatro" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($array[15]["objetivo_dec"]); }?>" placeholder="Escribe tu cuarto objetivo"></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row56">
            ...
            <td class="column2 style54 null style54" colspan="2"><input name="InpPesoObjetivoCuatro" size="19" id="InpPesoObjetivoCuatro" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' <?php if ($resultjj> 0) { ?> value="<?php  if(trim($arr = json_encode($array[15]["peso_objetivo"]),'"') > 0 ){ echo trim($arr = json_encode($array[15]["peso_objetivo"]),'"'); } else{}  }?>"/></td>
            <td class="column4 style21 null"></td>
            <td class="column5 style19 null"></td>
            <td class="column6 style19 null"></td>
            <td class="column7 style19 null"></td>
          ...
          <tr class="row58">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjCuatroActClaveUnoCuatro" id="InpObjCuatroActClaveUnoCuatro" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[15]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjCuatroPesoActUnoCuatro" id="InpObjCuatroPesoActUnoCuatro" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[15]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[15]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjCuatroMetaActUnoCuatro" id="InpObjCuatroMetaActUnoCuatro" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[15]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjCuatroCalifActUnoCuatro" id="InpObjCuatroCalifActUnoCuatro" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[15]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[15]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[15]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjCuatroComentUnoCuatro" id="InpObjCuatroComentUnoCuatro" type="text" ><?php if ($resultjj> 0) {  echo trim($array[15]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row58">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjCuatroActClaveDosCuatro" id="InpObjCuatroActClaveDosCuatro" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[16]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjCuatroPesoActDosCuatro" id="InpObjCuatroPesoActDosCuatro" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[16]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[16]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjCuatroMetaActDosCuatro" id="InpObjCuatroMetaActDosCuatro" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[16]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjCuatroCalifActDosCuatro" id="InpObjCuatroCalifActDosCuatro" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[16]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[16]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[16]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjCuatroComentDosCuatro" id="InpObjCuatroComentDosCuatro" type="text" ><?php if ($resultjj> 0) {  echo trim($array[16]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row58">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjCuatroActClaveTresCuatro" id="InpObjCuatroActClaveTresCuatro" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[17]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjCuatroPesoActTresCuatro" id="InpObjCuatroPesoActTresCuatro" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[17]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[17]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjCuatroMetaActTresCuatro" id="InpObjCuatroMetaActTresCuatro" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[17]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjCuatroCalifActTresCuatro" id="InpObjCuatroCalifActTresCuatro" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[17]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[17]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode(round($array[17]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjCuatroComentTresCuatro" id="InpObjCuatroComentTresCuatro" type="text" ><?php if ($resultjj> 0) {  echo trim($array[17]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row61">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjCuatroActClaveCuatroCuatro" id="InpObjCuatroActClaveCuatroCuatro" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[18]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjCuatroPesoActCuatroCuatro" id="InpObjCuatroPesoActCuatroCuatro" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[18]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode(round($array[18]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjCuatroMetaActCuatroCuatro" id="InpObjCuatroMetaActCuatroCuatro" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[18]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjCuatroCalifActCuatroCuatro" id="InpObjCuatroCalifActCuatroCuatro" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[18]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode($array[18]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode(round($array[18]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjCuatroComentCuatroCuatro" id="InpObjCuatroComentCuatroCuatro" type="text" ><?php if ($resultjj > 0) {  echo trim($array[18]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row61">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjCuatroActClaveCincoCuatro" id="InpObjCuatroActClaveCincoCuatro" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[19]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjCuatroPesoActCincoCuatro" id="InpObjCuatroPesoActCincoCuatro" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[19]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode(round($array[19]["peso_ponderado_actividad"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjCuatroMetaActCincoCuatro" id="InpObjCuatroMetaActCincoCuatro" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[19]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjCuatroCalifActCincoCuatro" id="InpObjCuatroCalifActCincoCuatro" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[19]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column7 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode($array[19]["porcentaje_cumplimiento_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column8 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode(round($array[19]["calificacion_ponderada"])),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjCuatroComentCincoCuatro" id="InpObjCuatroComentCincoCuatro" type="text" ><?php if ($resultjj > 0) {  echo trim($array[19]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row62">
            <td class="column0">&nbsp;</td>
            <td class="column1 style50 s style51" colspan="2">Total </td>
            <td class="column3 style22 f"><?php if ($resultjj> 0) { echo trim(((int)$array[15]["peso_cada_actividad"] + (int)$array[16]["peso_cada_actividad"] + (int)$array[17]["peso_cada_actividad"] + (int)$array[18]["peso_cada_actividad"] + (int)$array[19]["peso_cada_actividad"] ) ); } ?></td>
            <td class="column4 style10 f"><?php if ($resultjj> 0) { echo trim(((float)$array[15]["peso_ponderado_actividad"] + (float)$array[16]["peso_ponderado_actividad"] + (float)$array[17]["peso_ponderado_actividad"] + (float)$array[18]["peso_ponderado_actividad"] + (float)$array[19]["peso_ponderado_actividad"] )) ; } ?></td> 
            <td class="column5 style10 null"></td>
            <td class="column6 style10 null"></td>
            <td class="column7 style10 null"></td>
            <td class="column8 style10 f"><?php if ($resultjj> 0) { echo trim(((float)$array[15]["calificacion_ponderada"] + (float)$array[16]["calificacion_ponderada"] + (float)$array[17]["calificacion_ponderada"] + (float)$array[18]["calificacion_ponderada"] + (float)$array[19]["calificacion_ponderada"] ) ); } ?></td>
            <td class="column9 style7 null"></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
    ...
    if ($resultjj > 0) { ?>
      ...
      <?php }else{ ?>
    <center><button id="btnguardarfor" name="btnguardarfor" class="btn btn-primary" onclick="realizaProceso();">Guardar</button></center>
    <?php  } ?> 
    <br>
...
function realizaProceso(){
      ...
      $.ajax({
        type: "POST", 
        url: "querys/ins_objet_form_new.php",
        data: datos, 
        beforeSend: function () {
  ...
  function realizaProcesoActu(){
      ...
      $.ajax({
        type: "POST", 
        url: "querys/ins_objet_act_form_new.php", 
        data: datos, 
        beforeSend: function () {
                    $("#resultado").html("Procesando, espere por favor...");
            }, 
