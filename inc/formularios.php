    ...
    <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0">
        ...
        <tbody>
          ...
          <tr class="row37">
            ...
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[0]["peso_ponderado_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            ...
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[0]["calificacion_ponderada"]),'"')."%"; } else{ echo "0%"; } ?></td>
          ...
          <tr class="row38">
            ...
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[1]["peso_ponderado_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            ...
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[1]["calificacion_ponderada"]),'"')."%"; } else{ echo "0%"; } ?></td>
          ...
          <tr class="row39">
            ...
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[2]["peso_ponderado_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            ...
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[2]["calificacion_ponderada"]),'"')."%"; } else{ echo "0%"; } ?></td>
          ...
          <td class="column0">&nbsp;</td>
            ...
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[3]["peso_ponderado_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            ...
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[3]["calificacion_ponderada"]),'"')."%"; } else{ echo "0%"; } ?></td>
          ...
          <tr class="row41">
            ...
            <td class="column3 style22 f"><?php if ($resultjj> 0) { echo trim(((int)$array[0]["peso_cada_actividad"] + (int)$array[1]["peso_cada_actividad"] + (int)$array[2]["peso_cada_actividad"] + (int)$array[3]["peso_cada_actividad"] ) ); } ?></td>
            <td class="column4 style10 f"><?php if ($resultjj> 0) { echo trim(((int)$array[0]["peso_ponderado_actividad"] + (int)$array[1]["peso_ponderado_actividad"] + (int)$array[2]["peso_ponderado_actividad"] + (int)$array[3]["peso_ponderado_actividad"] )) ; } ?></td>
            <td class="column5 style10 null"></td>
            <td class="column6 style10 null"></td>
            <td class="column7 style10 null"></td>
            <td class="column8 style10 f"><?php if ($resultjj> 0) {echo trim(((int)$array[0]["calificacion_ponderada"] + (int)$array[1]["calificacion_ponderada"] + (int)$array[2]["calificacion_ponderada"] + (int)$array[3]["calificacion_ponderada"] ) ); } ?></td>
          ...
          <tr class="row44">
            <td class="column0">&nbsp;</td>
            <td class="column1 style59 s style59" colspan="9"><input size="100%" name="InpObjetivoDos" class="auno"  id="InpObjetivoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($array[4]["objetivo_dec"]); }?>" placeholder="Escribe tu segundo objetivo"></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row45">
            ...
            <td class="column2 style54 null style54" colspan="2"><input name="InpPesoObjetivoDos" size="19" id="InpPesoObjetivoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php  if(trim($arr = json_encode($array[4]["peso_objetivo"]),'"') > 0 ){ echo trim($arr = json_encode($array[4]["peso_objetivo"]),'"'); } else{}  }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style21 null"></td>
            <td class="column5 style19 null"></td>
            <td class="column6 style19 null"></td>
            <td class="column7 style19 null"></td>
          ...
          <tr class="row47">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveUnoDos" id="InpObjDosActClaveUnoDos" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[4]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActUnoDos" id="InpObjDosPesoActUnoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[4]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[4]["peso_ponderado_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActUnoDos" id="InpObjDosMetaActUnoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[4]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjDosCalifActUnoDos" id="InpObjDosCalifActUnoDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[4]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            ...
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[4]["calificacion_ponderada"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentUnoDos" id="InpObjDosComentUnoDos" type="text" ><?php if ($resultjj> 0) {  echo trim($array[4]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row48">
          <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveDosDos" id="InpObjDosActClaveDosDos" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[5]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActDosDos" id="InpObjDosPesoActDosDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[5]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[5]["peso_ponderado_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActDosDos" id="InpObjDosMetaActDosDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[5]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjDosCalifActDosDos" id="InpObjDosCalifActDosDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[5]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            ...
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[5]["calificacion_ponderada"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentDosDos" id="InpObjDosComentDosDos" type="text" ><?php if ($resultjj> 0) {  echo trim($array[5]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row49">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveTresDos" id="InpObjDosActClaveTresDos" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[6]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActTresDos" id="InpObjDosPesoActTresDos" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[6]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[6]["peso_ponderado_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActTresDos" id="InpObjDosMetaActTresDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[6]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjDosCalifActTresDos" id="InpObjDosCalifActTresDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[6]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            ...
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[6]["calificacion_ponderada"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentTresDos" id="InpObjDosComentTresDos" type="text" ><?php if ($resultjj> 0) {  echo trim($array[6]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row50">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjDosActClaveCuatroDos" id="InpObjDosActClaveCuatroDos" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[7]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjDosPesoActCuatroDos" id="InpObjDosPesoActCuatroDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[7]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[7]["peso_ponderado_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjDosMetaActCuatroDos" id="InpObjDosMetaActCuatroDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[7]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjDosCalifActCuatroDos" id="InpObjDosCalifActCuatroDos" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[7]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            ...
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[7]["calificacion_ponderada"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjDosComentCuatroDos" id="InpObjDosComentCuatroDos" type="text" ><?php if ($resultjj> 0) {  echo trim($array[7]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row51">
            <td class="column0">&nbsp;</td>
            <td class="column1 style50 s style51" colspan="2">Total </td>
            <td class="column3 style22 f"><?php if ($resultjj> 0) { echo trim(((int)$array[4]["peso_cada_actividad"] + (int)$array[5]["peso_cada_actividad"] + (int)$array[6]["peso_cada_actividad"] + (int)$array[7]["peso_cada_actividad"] ) ); } ?></td>
            <td class="column4 style10 f"><?php if ($resultjj> 0) { echo trim(((int)$array[4]["peso_ponderado_actividad"] + (int)$array[5]["peso_ponderado_actividad"] + (int)$array[6]["peso_ponderado_actividad"] + (int)$array[7]["peso_ponderado_actividad"] )); } ?></td>
            <td class="column5 style10 null"></td>
            <td class="column6 style10 null"></td>
            <td class="column7 style10 null"></td>
            <td class="column8 style10 f"><?php if ($resultjj> 0) { echo trim(((int)$array[4]["calificacion_ponderada"] + (int)$array[5]["calificacion_ponderada"] + (int)$array[6]["calificacion_ponderada"] + (int)$array[7]["calificacion_ponderada"] ) ); } ?></td>
            <td class="column9 style7 null"></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          ...
          <tr class="row55">
            <td class="column0">&nbsp;</td>
            <td class="column1 style59 s style59" colspan="9"><input size="100%" name="InpObjetivoTres" class="auno"  id="InpObjetivoTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($array[8]["objetivo_dec"]); }?>" placeholder="Escribe tu tercer objetivo"></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row56">
            ...
            <td class="column2 style54 null style54" colspan="2"><input name="InpPesoObjetivoTres" size="19" id="InpPesoObjetivoTres" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' <?php if ($resultjj> 0) { ?> value="<?php  if(trim($arr = json_encode($array[8]["peso_objetivo"]),'"') > 0 ){ echo trim($arr = json_encode($array[8]["peso_objetivo"]),'"'); } else{}  }?>"/></td>
            <td class="column4 style21 null"></td>
            <td class="column5 style19 null"></td>
            <td class="column6 style19 null"></td>
            <td class="column7 style19 null"></td>
          ...
          <tr class="row58">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveUnoTres" id="InpObjTresActClaveUnoTres" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[8]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActUnoTres" id="InpObjTresPesoActUnoTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[8]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[8]["peso_ponderado_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActUnoTres" id="InpObjTresMetaActUnoTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[8]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjTresCalifActUnoTres" id="InpObjTresCalifActUnoTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[8]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            ...
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[8]["calificacion_ponderada"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentUnoTres" id="InpObjTresComentUnoTres" type="text" ><?php if ($resultjj> 0) {  echo trim($array[8]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row59">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveDosTres" id="InpObjTresActClaveDosTres" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[9]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActDosTres" id="InpObjTresPesoActDosTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[9]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[9]["peso_ponderado_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActDosTres" id="InpObjTresMetaActDosTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[9]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjTresCalifActDosTres" id="InpObjTresCalifActDosTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[9]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            ...
            <td class="column8 style9 f"><?php if ($resultjj> 0) {  echo trim($arr = json_encode($array[9]["calificacion_ponderada"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentDosTres" id="InpObjTresComentDosTres" type="text" ><?php if ($resultjj> 0) {  echo trim($array[9]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row60">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveTresTres" id="InpObjTresActClaveTresTres" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[10]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActTresTres" id="InpObjTresPesoActTresTres" type="text" <?php if ($resultjj> 0) { ?> value="<?php echo trim($arr = json_encode($array[10]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode($array[10]["peso_ponderado_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActTresTres" id="InpObjTresMetaActTresTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[10]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjTresCalifActTresTres" id="InpObjTresCalifActTresTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[10]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            ...
            <td class="column8 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode($array[10]["calificacion_ponderada"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentTresTres" id="InpObjTresComentTresTres" type="text" ><?php if ($resultjj > 0) {  echo trim($array[10]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row61">
            <td class="column0">&nbsp;</td>
            <td class="column1 style53 s style53" colspan="2"><textarea  cols="38" rows="2"  name="InpObjTresActClaveCuatroTres" id="InpObjTresActClaveCuatroTres" type="text" placeholder="Actividades Clave"><?php if ($resultjj> 0) {  echo trim($array[11]["actividades_clave"]); }?></textarea></td>
            <td class="column3 style23 null"><input size="13" maxlength="3" name="InpObjTresPesoActCuatroTres" id="InpObjTresPesoActCuatroTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[11]["peso_cada_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column4 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode($array[11]["peso_ponderado_actividad"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column5 style15 null"><input size="13" maxlength="3" name="InpObjTresMetaActCuatroTres" id="InpObjTresMetaActCuatroTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[11]["meta_esperada_de_actividad"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            <td class="column6 style15 null"><input size="13" maxlength="3" name="InpObjTresCalifActCuatroTres" id="InpObjTresCalifActCuatroTres" type="text" <?php if ($resultjj > 0) { ?> value="<?php echo trim($arr = json_encode($array[11]["calificacion_actual"]),'"'); }?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>
            ...
            <td class="column8 style9 f"><?php if ($resultjj > 0) {  echo trim($arr = json_encode($array[11]["calificacion_ponderada"]),'"')."%"; } else{ echo "0%"; } ?></td>
            <td class="column9 style7 null"><textarea  cols="22" rows="1" name="InpObjTresComentCuatroTres" id="InpObjTresComentCuatroTres" type="text" ><?php if ($resultjj > 0) {  echo trim($array[11]["comentarios"]); }?></textarea></td>
            <td class="column10">&nbsp;</td>
            <td class="column11">&nbsp;</td>
          </tr>
          <tr class="row62">
            <td class="column0">&nbsp;</td>
            <td class="column1 style50 s style51" colspan="2">Total </td>
            <td class="column3 style22 f"><?php if ($resultjj> 0) { echo trim(((int)$array[8]["peso_cada_actividad"] + (int)$array[9]["peso_cada_actividad"] + (int)$array[10]["peso_cada_actividad"] + (int)$array[11]["peso_cada_actividad"] ) ); } ?></td>
            <td class="column4 style10 f"><?php if ($resultjj> 0) { echo trim(((int)$array[8]["peso_ponderado_actividad"] + (int)$array[9]["peso_ponderado_actividad"] + (int)$array[10]["peso_ponderado_actividad"] + (int)$array[11]["peso_ponderado_actividad"] )) ; } ?></td> 
            <td class="column5 style10 null"></td>
            <td class="column6 style10 null"></td>
            <td class="column7 style10 null"></td>
            <td class="column8 style10 f"><?php if ($resultjj> 0) { echo trim(((int)$array[8]["calificacion_ponderada"] + (int)$array[9]["calificacion_ponderada"] + (int)$array[10]["calificacion_ponderada"] + (int)$array[11]["calificacion_ponderada"] ) ); } ?></td>
