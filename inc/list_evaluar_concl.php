    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
                type="button" role="tab" aria-controls="nav-home" aria-selected="true">2023</button>
            <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile"
                type="button" role="tab" aria-controls="nav-profile" aria-selected="false">2022</button>
    ...
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <table class="table table-hover table-condensed table-bordered" id="myTable">
                ...
                where ev.id_user = $id_user and sl.evaluadodos = 1"; 
        ...
        // if ($_SESSION['viewdoc_' . $filaup['id_tipo_documento']] . "" == "1") {
                    ...
                    <tr>
                        ...
                        <td><?php
                        echo ' <a class="btn btn-danger black-background white" href="form_evaluacion.php?id=' . $filasolic['id_slack'] . '&po='. $filasolic['id_departamento'].'" >Detalles</a>';
    ...
    // }
        ...
        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
            <table class="table table-hover table-condensed table-bordered" id="myTable">
                ...
                $querysolicitud =  "SELECT  w.nombre_completo, w.nombreposicion, w.departamento, w.direccion, sl.id_slack 
                from evaluadores ev
                left join slack sl on sl.id_evaluador = ev.id
                left join workbeat w on w.id_slack = sl.id_slack
                where ev.id_user = $id_user and sl.evaluado = 1"; 
                $resultadosolicitud = mysqli_query($conexion, $querysolicitud);
                $numero = mysqli_num_rows($resultadosolicitud);
        ...
        // if ($_SESSION['viewdoc_' . $filaup['id_tipo_documento']] . "" == "1") {
                    ...
                    <tr>
                        ...
                        <td><?php
                        echo ' <a class="btn btn-danger black-background white" href="form_eval.php?id=' . $filasolic['id_slack'] . '" >Detalles</a>';
